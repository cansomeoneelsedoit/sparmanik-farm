...
export const config = {
  matcher: [
    ...
    "/((?!api/auth|api/health|api/uploads|api/admin/upload-passthrough|api/items/.+/photo|api/customers/[^/]+/logo|_next/static|_next/image|favicon.ico|farm-legacy.js|.*\\.(?:svg|png|jpg|jpeg|gif|webp|ico)$).*)",
  ],
};
